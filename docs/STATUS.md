...
- **P1 앱(Flutter/웹) 반영 대기**: 공수 단가유형 입력(0.5단위 스텝퍼)·`totalGongsu` 표시, 세금계산서 화면(tax-invoice-data 조회·복사·mark), 카카오 로그인 버튼+계정 연결(`/auth/kakao/link`). API 변경점은 아래 API-SPEC 및 worklog 참조.
