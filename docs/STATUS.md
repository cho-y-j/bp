...
- ✅ **P1 앱(Flutter) 반영 완료** (`worklog/2026-07-11-P1-앱.md`). 남은 P1: **웹(Next.js) 반영 대기** — 공수 라벨·세금계산서(있다면) 표기, **P1-다국어 배치**(i18n 이식: 앱 신규 문구 하드코딩 상태 → ARB 추출 필요, 상세는 P1-앱 worklog "미완/주의사항" 참조).
...
- **앱 다국어 배치 대기**: 웹 다국어(`web/lib/i18n`)의 사전 구조·키·언어결정 우선순위·데이터/라벨 분리 규칙을 Flutter(intl/ARB)로 이식. 6개 언어 문구·통화(`₩`/`원`)·`LANG_LOCALE` 매핑 재사용. 확인서 PDF 이중언어 옵션(백엔드)은 별도. 상세: `worklog/2026-07-11-P1-다국어-웹.md`.
